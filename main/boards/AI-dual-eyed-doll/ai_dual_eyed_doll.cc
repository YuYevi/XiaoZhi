...
static const gc9d01n_lcd_init_cmd_t kGc9d01nBoeInitCmds[] = {
    ...
    {0x6E,
     (uint8_t[]){0x03, 0x03, 0x01, 0x01, 0x00, 0x00, 0x0F, 0x0F, 0x0D, 0x0D, 0x0B, 0x0B, 0x09, 0x09,
                 0x00, 0x00, 0x00, 0x00, 0x0A, 0x0A, 0x0C, 0x0C, 0x0E, 0x0E, 0x10, 0x10, 0x00, 0x00,
                 0x02, 0x02, 0x04, 0x04},
     32, 0},
...
private:
    ...
    void CreateEyePanel(gpio_num_t cs_pin, bool mirror_x, esp_lcd_panel_io_handle_t* io_out,
        ...
        gc9d01n_vendor_config_t vendor_config = {};
        vendor_config.init_cmds = kGc9d01nBoeInitCmds;
        vendor_config.init_cmds_size =
            sizeof(kGc9d01nBoeInitCmds) / sizeof(kGc9d01nBoeInitCmds[0]);
        esp_lcd_panel_dev_config_t panel_config = {};
        panel_config.reset_gpio_num = GPIO_NUM_NC;
        panel_config.rgb_ele_order = LCD_RGB_ELEMENT_ORDER_RGB;
        panel_config.bits_per_pixel = 16;
        panel_config.vendor_config = &vendor_config;
        ESP_ERROR_CHECK(esp_lcd_new_panel_gc9d01n(*io_out, &panel_config, panel_out));
        ESP_ERROR_CHECK(esp_lcd_panel_reset(*panel_out));
        ESP_ERROR_CHECK(esp_lcd_panel_init(*panel_out));
        ESP_ERROR_CHECK(esp_lcd_panel_invert_color(*panel_out, false));
